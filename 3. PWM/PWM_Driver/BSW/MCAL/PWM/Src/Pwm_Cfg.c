...
*                              VERSION INFORMATION                                     *
****************************************************************************************/
#define PWM_CFG_SW_MAJOR_VERSION_C    1
#define PWM_CFG_SW_MINOR_VERSION_C    0
#define PWM_CFG_SW_PATCH_VERSION_C    0

/* Version compatibility checks */
#if (PWM_CFG_SW_MAJOR_VERSION != PWM_CFG_SW_MAJOR_VERSION_C)
    #error "PWM_Cfg.c: Version mismatch in Major version"
#endif

#if (PWM_CFG_SW_MINOR_VERSION != PWM_CFG_SW_MINOR_VERSION_C)
    #error "PWM_Cfg.c: Version mismatch in Minor version"
#endif

#if (PWM_CFG_SW_PATCH_VERSION != PWM_CFG_SW_PATCH_VERSION_C)
    #error "PWM_Cfg.c: Version mismatch in Patch version"
#endif
